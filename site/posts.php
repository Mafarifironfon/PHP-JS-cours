        ...
        <div class="row">
            ...
            <div class="col-4 d-flex align-items-center justify-content-around">
                ...
                <form action="./login.php" method="POST">
                    <button type="submit" name="deleteUser" class="btn btn-outline-warning">Supprimer mon
                        compte</button>
                </form>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center py-3">
                ...
                <a class="btn btn-light" href="http://localhost/php-start12/site/interfaceadmin.php">Interface
                    administrateur</a>
                <?php } ?>
            </div>
        </div>
